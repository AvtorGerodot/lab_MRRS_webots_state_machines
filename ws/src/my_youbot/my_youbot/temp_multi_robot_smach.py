...
# для каждого робота: какой индекс коридора он использует
# при движении по левому маршруту и по правому маршруту
ROBOT_CORRIDOR_INDEX = {
    'my_robot_0': {'left': -1, 'right':  0},
    'my_robot_1': {'left':  0, 'right':  1},
    'my_robot_2': {'left':  1, 'right': -1},   # для примера: у робота2 левый и правый маршруты переставлены
}
...
BASE_ROUTE = [
    ...
    ( 0.0, -2.5,  3.1415),   # 3 - поворот наверх
